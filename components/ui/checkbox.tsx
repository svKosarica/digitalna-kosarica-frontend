...
function Checkbox({
  ...
  return (
    ...
    >
      ...
      >
        {/* Radix mounts the Indicator for indeterminate as well as checked, so
            without this swap a partly-selected parent is indistinguishable
            from a fully-selected one. */}
